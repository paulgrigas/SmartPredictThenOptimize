...
results <- read_csv("shortest_path.csv") # CSV file should contain all SP results for n = 100, 1000, 5000 merged together

results = results %>% filter(grid_dim == 5 & p_features == 5)
